...
/**
 * Authentication form supporting login and signup modes.
 * Handles email/password submission and OAuth provider sign-in.
 *
 * @param props.mode - Either "login" or "signup" (default: "login")
 * @returns A form with email/password fields and OAuth provider buttons
 */
